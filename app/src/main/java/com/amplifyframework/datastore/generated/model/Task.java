...
public final class Task implements Model {
  ...
  private Task(String id, String title, String description, TaskCategoryEnum taskCategory) {
    this.id = id;
    this.title = title;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String description, TaskCategoryEnum taskCategory) {
      super.id(id);
      super.title(title)
